...
// Validate ../../app/admin/login/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/admin/login">> = Specific
  const handler = {} as typeof import("../../app/admin/login/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
